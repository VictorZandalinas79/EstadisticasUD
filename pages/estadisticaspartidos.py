...
def get_sheet_data(sheet_name):
    ...
    try:
        ...
        # Si no existe el archivo de credenciales, crearlo con las credenciales proporcionadas
        if not os.path.exists(credentials_path):
            print(f"Creando archivo de credenciales en: {credentials_path}")
            credentials_json = {
                "type": "service_account",
                "project_id": "datosudatzenetaopython",
                "private_key_id": "d564141c14233a93a1a36ae69623ff2324de423c",
                "private_key": "-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n",
                "client_email": "python-udatzeneta@datosudatzenetaopython.iam.gserviceaccount.com",
                "client_id": "110322444167089809762",
                "auth_uri": "https://accounts.google.com/o/oauth2/auth",
                "token_uri": "https://oauth2.googleapis.com/token",
                "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
                "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/python-udatzeneta%40datosudatzenetaopython.iam.gserviceaccount.com",
